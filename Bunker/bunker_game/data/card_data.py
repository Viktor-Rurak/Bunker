...
def get_additional_info():
    additional_info = {
        ...
        "Колись врятував людину з пожежі": {"tag": "security"},
        "Був у зоні бойових дій": {"tag": "weapons"},
        "Має залежність від кави": {"tag": "habit"},
        "У дитинстві пережив аварію": {"tag": "trauma"},
        "Колись крав у магазині": {"tag": "crime"},
        "Має психічний розлад, але приховує це": {"tag": "psychology"},
        "Є відеоблогером із великою аудиторією": {"tag": "media"},
        "Володіє технікою медитації": {"tag": "psychology"},
        "Є фанатом змови про інопланетян": {"tag": "technology"},
        "Має надзвичайно розвинену інтуїцію": {"tag": "intuition"},
        "У минулому — співробітник спецслужб": {"tag": "security"},
        ...
        "Має сертифікат психолога": {"tag": "psychology"},
        "Ненавидить зброю після військових подій": {"tag": "belief"},
        "Колись створив штучний інтелект, який вийшов з-під контролю": {"tag": "technology"},
        "Потайки має дитину за межами бункера": {"tag": "family"},
        "Займається чорної магією або ритуалами": {"tag": "faith"},
